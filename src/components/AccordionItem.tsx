...
const faqData = [
  {
    ...
    answer: "We deliver 24/7 multilingual contact center solutions including inbound customer support, outbound sales & collections, technical support."
  },
  {
    question: "Do you support multiple languages?",
    answer: "Yes, we support over 30 languages with native-level fluency to ensure seamless communication globally."
  },
  {
    question: "How is pricing structured?",
    answer: "Our pricing is customized based on seat count, language requirements, and support hours. Contact us for a tailored quote."
  },
  {
    question: "What contract terms do you offer?",
    answer: "We offer flexible contract terms ranging from month-to-month pilots to long-term annual agreements depending on your needs."
  }
];
...
const AccordionItem = ({ question, answer, isOpen, onClick }:{
  ...
  return (
    <div 
      className={`rounded-2xl overflow-hidden mb-4 transition-colors duration-300 ${isOpen ? 'bg-gray-50' : 'bg-gray-50/80 hover:bg-gray-50'}`}
    >
      {/* Clickable Header */}
      <button 
        onClick={onClick} 
      ...
      >
        ...
        <div className={`flex-shrink-0 w-10 h-10 bg-[#594ad2] rounded-full flex items-center justify-center transition-transform duration-300 ease-in-out ${isOpen ? 'rotate-180' : ''}`}>
